...
\answer{We added a paragraph in Related Work to discuses the difference and related scheduling algorithms.}
...
\answer{We added a link where other researchers can download our traces.}

\revised{Traces, profile data, and characterizations are freely available online for the community [68]. }
...
\answer{We added a paragraph to discuss the general recommendations in Section 4.3:}

\revised{Our experimental results show that adaptive task reclustering methods outcomes better performance than simple static methods that retry failed clustered jobs...}
