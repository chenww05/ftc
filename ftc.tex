...
inter-arrival time of task failures). $\theta_{\gamma}$ ranges from 1 to 10 times of the 
average task runtime such that the workflows do not run continuously and the performance 
difference is visually explicit. 
