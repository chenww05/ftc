...
\author{Weiwei~Chen,~\IEEEmembership{Student Member,~IEEE,}
        Rafael~Ferreira~da~Silva,~\IEEEmembership{Member,~IEEE,}
	Ewa~Deelman, ~\IEEEmembership{Member, ~IEEE,}
        and~Thomas~Fahringer,~\IEEEmembership{Member,~IEEE}% <-this % stops a space
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem W. Chen, R. Silva and E. Deelman are with the Information Sciences Institute, University of Southern California, Marina del Rey, CA, USA.\protect\\
