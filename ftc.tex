...
\begin{figure}[t]
	...
	\small (a) $\tau=0.1T_c$ \\ \vspace{5pt}
	\includegraphics[width=1\linewidth]{pulse_t30.eps} \\
	\small (b) $\tau=0.3T_c$ \\ \vspace{5pt}
	\includegraphics[width=1\linewidth]{pulse_t50.eps} \\
	\small (c) $\tau=0.5T_c$
	\caption{(\emph{Experiment 3}): Static Estimation vs. Dynamic Estimation (CyberShake, Pulse Function).}
	\label{fig:exp3}
\end{figure}
...
This work is supported by NFS under grant number IIS-0905032. We thank Gideon Juve, 
