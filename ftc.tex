...
online for the community~\cite{WorkflowArchive}. For the experiments we generated... 
\note{Weiwei: provide the number of synthetic workflows generated for each application 
and the number of tasks in each workflow.}}
...
\rev{In this experiment, ...}
\note{Weiwei: provide information on how did you determine the shape and scale 
parameters to estimate the MLEs of the unknown parameters in the simulations.}
