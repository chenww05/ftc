...
EC2~\cite{AmazonAWS} and FutureGrid~\cite{FutureGrid}. \rev{It is also consistent with the setting of many real execution experiments~\cite{Juve2013}. } 
...
in FutureGrid from where our traces were collected. \rev{According to the execution model of WorkflowSim, the network bandwidth is the maximum allowed data transfer speed between a pair of virtual machines for each file. }By default, tasks at the same horizontal level 
...
structure of the generated workflow. \rev{Traces, profile data, and characterizations are freely available
online for the community through the Workflow Gallery Project\footnote{http://www.workflowarchive.org}.}
