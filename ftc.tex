...
fits several WMS such as Pegasus~\cite{Deelman2005, Deelman-FGCS-2014}, Askalon~\cite{fahringer2007askalon}, and 
...
workflow~\cite{Deelman2005, Deelman-FGCS-2014} provided by the user or a workflow composition system. It restructures 
...
job scheduler is denoted as the \textbf{workflow engine delay}.
...
denoted as the \textbf{queue delay}. It reflects both the efficiency of the job scheduler and the 
...
based on our prior study on workflow analysis~\cite{Chen2011}. \rev{To make our statement more convincing, Table~\ref{tab:model-overheads} shows the system overheads and task runtimes of three widely used scientific workflows captured from real traces. Details about these scientific workflows will be introduced in Section~\ref{sec:applications}. }
...
\begin{table*}[!htb]
	...
	\begin{tabular}{lrrrrrr}
		...
		\hline
	\end{tabular}
	\caption{System Overheads and Task Runtimes from Real Traces.}
