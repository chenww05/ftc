...
%Transient errors in computer systems have been analyzed in~\cite{McConnel} and showed that transient errors follow a Weibull distribution. In \cite{Sun2003, Iosup2008}, Weibull distribution is one of the best fit for the workflow traces they used.  Based on these studies, we measure the inter-arrival time of failures in a workflow and then provide methods to improve task clustering. 
