...
based on our prior study on workflow analysis~\cite{Chen2011}. \rev{Table~\ref{tab:model-overheads} shows the system overheads and task runtimes of three widely used scientific workflows captured from real traces. Details about these scientific workflows will be introduced in Section~\ref{sec:applications}. The statistical information about these traces is consistent with our claim that system overheads constitute a significant portion of the overall runtime during the workflow execution. }
